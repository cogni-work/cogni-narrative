...
```
references/story-arc/industry-transformation/arc-definition.md
references/story-arc/industry-transformation/forces-patterns.md
references/story-arc/industry-transformation/friction-patterns.md
references/story-arc/industry-transformation/evolution-patterns.md
references/story-arc/industry-transformation/leadership-patterns.md
```
...
2. Apply industry-transformation patterns from loaded references
